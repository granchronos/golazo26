...
import { RoomLeaderboard } from '@/components/groups/RoomLeaderboard'
...
export function GroupRoom({
  ...
  // Fetch scorers on mount + poll every 5 minutes (external API, no Realtime available)
  useEffect(() => {
    loadScorers()
    const interval = setInterval(loadScorers, 300_000) // every 5 min
    ...
    <div className="space-y-4">
      ...
      <div className={activeTab === 'leaderboard' ? '' : 'hidden'}>
        <RoomLeaderboard
          ...
          roomPoolEnabled={room.pool_enabled}
