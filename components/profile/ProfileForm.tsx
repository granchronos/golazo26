    ...
    <div className="space-y-6">
      ...
      <div className="glass-card overflow-hidden">
        <div className="px-4 sm:px-5 py-3 bg-gray-50 dark:bg-white/[0.03] border-b border-gray-100 dark:border-white/[0.06] flex items-center gap-2">
          ...
          <span className="text-xs font-display uppercase tracking-wider text-gray-500 dark:text-gray-400">
        ...
        <form action={profileAction} className="p-4 sm:p-5 space-y-4">
          <div>
            <label
              htmlFor="name"
              className="block text-xs font-body font-medium text-gray-500 dark:text-gray-400 mb-1.5"
            >
              Nombre
            </label>
            <input
          ...
          <div>
            ...
            <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-gray-100 dark:border-white/[0.06] bg-gray-50 dark:bg-white/[0.02] text-sm font-body text-gray-500 dark:text-gray-400">
              {email}
              {isOAuth && (
                <span className="text-[10px] font-mono bg-gray-100 dark:bg-white/[0.06] px-2 py-0.5 rounded-full">
                  Google
                </span>
              )}
            </div>
      ...
      <div className="glass-card overflow-hidden border-red-200 dark:border-red-500/20">
        <div className="px-4 sm:px-5 py-3 bg-red-50 dark:bg-red-500/[0.06] border-b border-red-100 dark:border-red-500/10 flex items-center gap-2">
          ...
          <span className="text-xs font-display uppercase tracking-wider text-red-500">
            Zona peligrosa
          </span>
        </div>
        <div className="p-4 sm:p-5">
          <p className="text-sm font-body text-gray-500 dark:text-gray-400 mb-4">
            Al eliminar tu cuenta se borrarán todas tus predicciones y puntuaciones. Si eres admin
            de una sala con otros miembros, el rol se transferirá automáticamente. Las salas donde
            seas el único miembro serán eliminadas.
          </p>
          ...
          <AnimatePresence>
            {!showDelete ? (
              ...
              >
                ...
                {deleteError && <p className="text-sm font-body text-red-500">{deleteError}</p>}
