  ...
  return (
    <div className="glass-card p-4">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-sm font-body font-medium text-gray-600 dark:text-gray-300">
          {label}
        </span>
      </div>
      <div className="flex items-center gap-3">
        {days > 0 && <TimeUnit value={days} label="días" urgent={false} />}
