        ...
        >
          ...
          {(() => {
            ...
            if (errorParam) {
              if (errorParam === 'OAuthCallbackError') {
                ...
                friendlyError =
                  'No se pudo crear el perfil de usuario. Por favor, vuelve a intentar iniciar sesión.'
              } else {
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-[#FAFAFA] dark:bg-[#0a0a0f] px-3 text-xs font-body text-gray-400">
                o con correo
              </span>
            </div>
          </div>
          ...
          <p className="text-center text-sm font-body text-gray-400 mt-6">
            ...
            <Link
              ...
              className="text-[#2A398D] dark:text-blue-400 hover:underline font-medium"
            >
              Crear cuenta
            </Link>
          </p>
