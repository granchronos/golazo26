...
const DATA: Record<string, MatchupData> = {
  ...
  [key('mex', 'rsa')]: {
    ...
    facts: [
      {
        title: 'Debut copero',
        detail: 'Sudáfrica fue el anfitrión en 2010, el primer Mundial en África.',
      },
      {
        title: 'Bafana Bafana',
        detail: 'Sudáfrica es el único anfitrión eliminado en fase de grupos.',
      },
    ],
  },
  [key('kor', 'cze')]: {
    ...
    facts: [
      ...
      {
        title: 'Corea 2002',
        detail: 'Corea del Sur llegó a semifinales como coanfitrión en 2002.',
      },
  ...
  [key('mex', 'kor')]: {
    ...
    facts: [
      {
        title: 'Quinto maldito',
        detail: 'México ha sido eliminado en octavos en 7 mundiales consecutivos (1994-2022).',
      },
      {
        title: 'Rivales directos',
        detail: 'En 2018, México venció 2-1 a Corea, pero ambos avanzaron.',
      },
    ],
  },
  [key('mex', 'cze')]: {
  ...
  [key('rsa', 'kor')]: {
    ...
    facts: [
      {
        title: 'Mundiales africanos',
        detail: 'Sudáfrica sigue siendo el único país africano en haber sido sede.',
      },
    ],
  },
  [key('rsa', 'cze')]: {
    wcMeetings: 0,
    facts: [{ title: 'Sin historial', detail: 'Nunca se han enfrentado en la Copa del Mundo.' }],
  },
  ...
  [key('can', 'sui')]: {
    ...
    facts: [
      {
        title: 'Regreso esperado',
        detail: 'Canadá volvió a un Mundial en 2022 después de 36 años (1986).',
      },
    ],
  },
  ...
  [key('bra', 'mar')]: {
    ...
    facts: [
      {
        title: 'Marruecos 2022',
        detail: 'Marruecos hizo historia en 2022 como primer equipo africano en semis.',
      },
  ...
  [key('usa', 'tur')]: {
    ...
    facts: [
      {
        title: 'Coanfitrión',
        detail: 'EE.UU. es coanfitrión del Mundial 2026 junto a México y Canadá.',
      },
      {
        title: 'Turquía 2002',
        detail: 'Turquía llegó a semifinales en su mejor actuación mundialista.',
      },
    ],
  },
  [key('usa', 'pry')]: {
  ...
  [key('ger', 'ecu')]: {
    ...
    facts: [{ title: 'Anfitrión 2006', detail: 'Alemania fue sede en 2006, terminó 3° lugar.' }],
  },
  ...
  [key('ned', 'jpn')]: {
    ...
    facts: [
      {
        title: 'Finalistas',
        detail: 'Países Bajos ha sido 3 veces finalista sin ganar (1974, 1978, 2010).',
      },
  ...
  [key('swe', 'jpn')]: {
    ...
    facts: [
      {
        title: 'Suecia 1958',
        detail: 'Suecia fue finalista como anfitrión en 1958, perdiendo ante Brasil.',
      },
    ],
  },
    ...
    facts: [
      {
        ...
        detail: 'Bélgica alcanzó semifinales en 2018 con De Bruyne, Hazard y Lukaku.',
      },
  ...
  [key('esp', 'ksa')]: {
    ...
    facts: [
      {
        title: 'Shock 2022',
        detail: 'Arabia Saudita venció a Argentina 2-1 en el partido más sorpresivo.',
      },
    ],
  },
  ...
  [key('fra', 'sen')]: {
    ...
    facts: [
      {
        title: 'Shock inaugural',
        detail: 'Senegal derrotó a la campeona Francia en el partido inaugural 2002.',
      },
      {
        title: 'Bicampeona',
        detail: 'Francia ha ganado 2 mundiales (1998, 2018) y fue finalista en 2022.',
      },
    ],
  },
  ...
  [key('arg', 'alg')]: {
    ...
    facts: [
      ...
      {
        title: 'Sorpresa 1982',
        detail: 'Argelia derrotó a Alemania 2-1 en la "Vergüenza de Gijón" de 1982.',
      },
    ],
  },
  [key('arg', 'jor')]: {
    ...
    facts: [
      ...
      {
        title: 'Messi legacy',
        detail: 'Argentina busca defender el título ganado por Messi en Catar 2022.',
      },
    ],
  },
  ...
  [key('por', 'col')]: {
    ...
    facts: [
      ...
      {
        title: 'James 2014',
        detail: 'Colombia llegó a cuartos en 2014 con James Rodríguez como goleador.',
      },
    ],
  },
  [key('por', 'uzb')]: {
    wcMeetings: 0,
    facts: [{ title: 'Debut uzbeko', detail: 'Uzbekistán participará en su primer Mundial.' }],
  },
  ...
  [key('eng', 'cro')]: {
    ...
    facts: [
      {
        title: 'Revancha',
        detail: 'Croacia eliminó a Inglaterra en semis de 2018 con gol de Mandžukić.',
      },
  ...
  [key('eng', 'pan')]: {
    ...
    facts: [
      {
        title: 'Debut panameño',
        detail: 'Panamá debutó en el Mundial 2018 y celebró su primer gol mundialista.',
      },
    ],
  },
  [key('cro', 'gha')]: {
    ...
    facts: [
      {
        title: 'Croacia finalista',
        detail: 'Croacia fue finalista en 2018 y semifinalista en 2022.',
      },
      {
        title: 'Ghana 2010',
        detail: 'Ghana fue el último equipo africano en cuartos (2010, penal fallado de Gyan).',
      },
    ],
  },
}
